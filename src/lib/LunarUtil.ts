...
export class LunarUtil {
    static BASE_YEAR: number = 1900;
    static BASE_MONTH: number = 11;
    static BASE_DAY: number = 11;
    static BASE_INDEX: number = 0;
    static BASE_YEAR_JIU_XING_INDEX: number = 0;
    static BASE_YEAR_GANZHI_INDEX: number = -4;
    static BASE_DAY_GANZHI_INDEX: number = 15;
    static BASE_MONTH_ZHI_INDEX: number = 2;
    static BASE_WEEK_INDEX: number = 2;
    ...
    static NUMBER: string[] = ['〇', '一', '二', '三', '四', '五', '六', '七', '八', '九'];
    ...
    static GONG: Dictionary<string> = new Dictionary<string>([
        ['角', '东'], ['井', '南'], ['奎', '西'], ['斗', '北'], ['亢', '东'], ['鬼', '南'], ['娄', '西'], ['牛', '北'], ['氐', '南'], ['柳', '南'], ['胃', '西'], ['女', '北'], ['房', '东'], ['星', '南'], ['昴', '西'], ['虚', '北'], ['心', '东'], ['张', '南'], ['毕', '西'], ['危', '北'], ['尾', '东'], ['翼', '南'], ['觜', '西'], ['室', '北'], ['箕', '东'], ['轸', '南'], ['参', '西'], ['壁', '北']
    ]);
    static SHOU: Dictionary<string> = new Dictionary<string>([
        ['东', '青龙'], ['南', '朱雀'], ['西', '白虎'], ['北', '玄武']
    ]);
    static FESTIVAL: Dictionary<string> = new Dictionary<string>([
        ['1-1', '春节'], ['1-15', '元宵节'], ['2-2', '龙头节'], ['5-5', '端午节'], ['7-7', '七夕节'], ['8-15', '中秋节'], ['9-9', '重阳节'], ['12-8', '腊八节'], ['12-30', '除夕']
    ]);
    ...
    static computeAddDays(year: number, month: number, day: number): number {
        ...
        let diff = LunarUtil.getDaysOfMonth(y, m) - LunarUtil.BASE_DAY;
    ...
    static getLeapMonth(year: number): number {
        const index = year - LunarUtil.BASE_YEAR + LunarUtil.BASE_INDEX;
        let v = LunarUtil.LUNAR_MONTH[2 * index + 1];
        v = (v >> 4) & 0x0F;
        return v;
    }

    static nextMonth(y: number, m: number): number {
        let n = Math.abs(m) + 1;
        if (m > 0) {
    ...
    static getDaysOfMonth(year: number, month: number): number {
        ...
        if (1 <= month && month <= 8) {
            ...
            if (v !== Math.abs(month)) {
                ...
                d = 29;
                for (let i = 0, j = LunarUtil.LEAP_MONTH_YEAR.length; i < j; i++) {
                    if (LunarUtil.LEAP_MONTH_YEAR[i] === index) {
                        d = 30;
                        break;
                    }
                }
