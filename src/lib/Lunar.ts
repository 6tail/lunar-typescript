...
export class Lunar {
    ...
    static JIE_QI_IN_USE: string[] = [Lunar.JIE_QI_PREPEND, '冬至', '小寒', '大寒', '立春', '雨水', '惊蛰', '春分', '清明', '谷雨', '立夏', '小满', '芒种', '夏至', '小暑', '大暑', '立秋', '处暑', '白露', '秋分', '寒露', '霜降', '立冬', '小雪', '大雪', Lunar.JIE_QI_APPEND, Lunar.JIE_APPEND_SOLAR_FIRST, Lunar.QI_APPEND_SOLAR_SECOND];
